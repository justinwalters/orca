...
| P7-D | Implement the narrow read-only Resource Monitor REST adapter for provider quota snapshots, preserving native polling compatibility. | doing | codex | req | Adapter/tests/evidence committed; independent certification remains required. |
