...
| P7-E | Wire the certified RM adapter into the mini-hosted Orca runtime, IPC, and status UI with fail-closed runtime-only authentication and freshness handling. | doing | codex | req | Based on certified adapter commit `de75e5d424`. |
